# adventure-game - Task 19

Execute task 19 for the adventure-game specification.

## Task Description
Create API client utility in src/utils/api.js
...
## Usage
```
/Task:19-adventure-game
```

## Instructions

Execute with @spec-task-executor agent the following task: "Create API client utility in src/utils/api.js"

```
Use the @spec-task-executor agent to implement task 19: "Create API client utility in src/utils/api.js" for the adventure-game specification and include all the below context.
...
## Task Details
- Task ID: 19
- Description: Create API client utility in src/utils/api.js
- Requirements: 1.1

## Instructions
- Implement ONLY task 19: "Create API client utility in src/utils/api.js"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks adventure-game 19 --mode complete
...
```bash
claude-code-spec-workflow get-tasks adventure-game 19 --mode complete
```
