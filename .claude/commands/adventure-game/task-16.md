# adventure-game - Task 16

Execute task 16 for the adventure-game specification.

## Task Description
Create game API routes in api/routes/games.py

## Code Reuse
**Leverage existing code**: services/game
...
## Usage
```
/Task:16-adventure-game
```

## Instructions

Execute with @spec-task-executor agent the following task: "Create game API routes in api/routes/games.py"

```
Use the @spec-task-executor agent to implement task 16: "Create game API routes in api/routes/games.py" for the adventure-game specification and include all the below context.
...
## Task Details
- Task ID: 16
- Description: Create game API routes in api/routes/games.py
- Leverage: services/game
- Requirements: 3.1, 3.2, 4.1

## Instructions
- Implement ONLY task 16: "Create game API routes in api/routes/games.py"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks adventure-game 16 --mode complete
...
```bash
claude-code-spec-workflow get-tasks adventure-game 16 --mode complete
```
