# adventure-game - Task 11

Execute task 11 for the adventure-game specification.

## Task Description
Create project service in services/project_service.py

## Code Reuse
**Leverage existing code**: models/project.py, models/node.py, models/choice.py
...
## Usage
```
/Task:11-adventure-game
```

## Instructions

Execute with @spec-task-executor agent the following task: "Create project service in services/project_service.py"

```
Use the @spec-task-executor agent to implement task 11: "Create project service in services/project_service.py" for the adventure-game specification and include all the below context.
...
## Task Details
- Task ID: 11
- Description: Create project service in services/project_service.py
- Leverage: models/project.py, models/node.py, models/choice.py
- Requirements: 6.1, 6.2

## Instructions
- Implement ONLY task 11: "Create project service in services/project_service.py"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks adventure-game 11 --mode complete
...
```bash
claude-code-spec-workflow get-tasks adventure-game 11 --mode complete
```
