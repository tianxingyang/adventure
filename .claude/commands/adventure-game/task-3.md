# adventure-game - Task 3

Execute task 3 for the adventure-game specification.

## Task Description
Create Project model in models/project.py
...
## Usage
```
/Task:3-adventure-game
```

## Instructions

Execute with @spec-task-executor agent the following task: "Create Project model in models/project.py"

```
Use the @spec-task-executor agent to implement task 3: "Create Project model in models/project.py" for the adventure-game specification and include all the below context.
...
## Task Details
- Task ID: 3
- Description: Create Project model in models/project.py
- Leverage: models/base.py
- Requirements: 1.1, 6.1

## Instructions
- Implement ONLY task 3: "Create Project model in models/project.py"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks adventure-game 3 --mode complete
...
```bash
claude-code-spec-workflow get-tasks adventure-game 3 --mode complete
```
