# adventure-game - Task 12

Execute task 12 for the adventure-game specification.

## Task Description
Create export service in services/export_service.py
...
Execute with @spec-task-executor agent the following task: "Create export service in services/export_service.py"

```
Use the @spec-task-executor agent to implement task 12: "Create export service in services/export_service.py" for the adventure-game specification and include all the below context.
...
## Task Details
- Task ID: 12
- Description: Create export service in services/export_service.py
- Leverage: services/project
- Requirements: 4.1, 4.2

## Instructions
- Implement ONLY task 12: "Create export service in services/export_service.py"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks adventure-game 12 --mode complete
...
```bash
claude-code-spec-workflow get-tasks adventure-game 12 --mode complete
```
