# adventure-game - Task 10

Execute task 10 for the adventure-game specification.

## Task Description
Create game engine service in services/game_engine.py

## Code Reuse
**Leverage existing code**: services/condition
...
## Usage
```
/Task:10-adventure-game
```

## Instructions

Execute with @spec-task-executor agent the following task: "Create game engine service in services/game_engine.py"

```
Use the @spec-task-executor agent to implement task 10: "Create game engine service in services/game_engine.py" for the adventure-game specification and include all the below context.
...
## Task Details
- Task ID: 10
- Description: Create game engine service in services/game_engine.py
- Leverage: services/condition
- Requirements: 2.2, 3.1, 3.2

## Instructions
- Implement ONLY task 10: "Create game engine service in services/game_engine.py"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks adventure-game 10 --mode complete
...
```bash
claude-code-spec-workflow get-tasks adventure-game 10 --mode complete
```
