# adventure-game - Task 2

Execute task 2 for the adventure-game specification.

## Task Description
Create base database models in models/base.py
...
Execute with @spec-task-executor agent the following task: "Create base database models in models/base.py"

```
Use the @spec-task-executor agent to implement task 2: "Create base database models in models/base.py" for the adventure-game specification and include all the below context.
...
## Task Details
- Task ID: 2
- Description: Create base database models in models/base.py
- Requirements: 1.1

## Instructions
- Implement ONLY task 2: "Create base database models in models/base.py"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks adventure-game 2 --mode complete
...
```bash
claude-code-spec-workflow get-tasks adventure-game 2 --mode complete
```
