# adventure-game - Task 20

Execute task 20 for the adventure-game specification.

## Task Description
Create Zustand stores in src/stores/

## Code Reuse
**Leverage existing code**: src/utils/api.js
...
## Usage
```
/Task:20-adventure-game
```

## Instructions

Execute with @spec-task-executor agent the following task: "Create Zustand stores in src/stores/"

```
Use the @spec-task-executor agent to implement task 20: "Create Zustand stores in src/stores/" for the adventure-game specification and include all the below context.
...
## Task Details
- Task ID: 20
- Description: Create Zustand stores in src/stores/
- Leverage: src/utils/api.js
- Requirements: 3.1, 6.1

## Instructions
- Implement ONLY task 20: "Create Zustand stores in src/stores/"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks adventure-game 20 --mode complete
...
```bash
claude-code-spec-workflow get-tasks adventure-game 20 --mode complete
```
