# adventure-game - Task 21

Execute task 21 for the adventure-game specification.
...
## Usage
```
/Task:21-adventure-game
```

## Instructions

Execute with @spec-task-executor agent the following task: "Create base components in src/components/common/"

```
Use the @spec-task-executor agent to implement task 21: "Create base components in src/components/common/" for the adventure-game specification and include all the below context.
...
## Task Details
- Task ID: 21
- Description: Create base components in src/components/common/
- Requirements: 1.1, 5.1

## Instructions
- Implement ONLY task 21: "Create base components in src/components/common/"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks adventure-game 21 --mode complete
...
```bash
claude-code-spec-workflow get-tasks adventure-game 21 --mode complete
```
