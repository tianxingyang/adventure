# adventure-game - Task 1

Execute task 1 for the adventure-game specification.
...
```
Use the @spec-task-executor agent to implement task 1: "Create project structure and dependencies" for the adventure-game specification and include all the below context.
...
- Mark the task as complete using: claude-code-spec-workflow get-tasks adventure-game 1 --mode complete
...
```bash
claude-code-spec-workflow get-tasks adventure-game 1 --mode complete
```
