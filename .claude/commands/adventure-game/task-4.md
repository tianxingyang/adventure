...
Execute task 4 for the adventure-game specification.

## Task Description
Create GameNode model in models/node.py

## Code Reuse
**Leverage existing code**: models/base.py, models/project.py
...
Execute with @spec-task-executor agent the following task: "Create GameNode model in models/node.py"

```
Use the @spec-task-executor agent to implement task 4: "Create GameNode model in models/node.py" for the adventure-game specification and include all the below context.
...
## Task Details
- Task ID: 4
- Description: Create GameNode model in models/node.py
- Leverage: models/base.py, models/project.py
- Requirements: 1.1, 5.1

## Instructions
- Implement ONLY task 4: "Create GameNode model in models/node.py"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks adventure-game 4 --mode complete
...
```bash
claude-code-spec-workflow get-tasks adventure-game 4 --mode complete
```
