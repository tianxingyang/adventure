# adventure-game - Task 22

Execute task 22 for the adventure-game specification.

## Task Description
Create Node component for editor in src/components/editor/Node.js

## Code Reuse
**Leverage existing code**: src/components/common/, React Flow
...
## Usage
```
/Task:22-adventure-game
```

## Instructions

Execute with @spec-task-executor agent the following task: "Create Node component for editor in src/components/editor/Node.js"

```
Use the @spec-task-executor agent to implement task 22: "Create Node component for editor in src/components/editor/Node.js" for the adventure-game specification and include all the below context.
...
## Task Details
- Task ID: 22
- Description: Create Node component for editor in src/components/editor/Node.js
- Leverage: src/components/common/, React Flow
- Requirements: 1.1, 1.2, 5.1

## Instructions
- Implement ONLY task 22: "Create Node component for editor in src/components/editor/Node.js"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks adventure-game 22 --mode complete
...
```bash
claude-code-spec-workflow get-tasks adventure-game 22 --mode complete
```
