# adventure-game - Task 6

Execute task 6 for the adventure-game specification.

## Task Description
Create Condition model in models/condition.py

## Code Reuse
**Leverage existing code**: models/base.py, models/choice.py
...
## Usage
```
/Task:6-adventure-game
```

## Instructions

Execute with @spec-task-executor agent the following task: "Create Condition model in models/condition.py"

```
Use the @spec-task-executor agent to implement task 6: "Create Condition model in models/condition.py" for the adventure-game specification and include all the below context.
...
## Task Details
- Task ID: 6
- Description: Create Condition model in models/condition.py
- Leverage: models/base.py, models/choice.py
- Requirements: 2.1, 2.2

## Instructions
- Implement ONLY task 6: "Create Condition model in models/condition.py"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks adventure-game 6 --mode complete
...
```bash
claude-code-spec-workflow get-tasks adventure-game 6 --mode complete
```
