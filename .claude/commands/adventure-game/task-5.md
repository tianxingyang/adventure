# adventure-game - Task 5

Execute task 5 for the adventure-game specification.

## Task Description
Create Choice model in models/choice.py

## Code Reuse
**Leverage existing code**: models/base.py, models/node.py
...
## Usage
```
/Task:5-adventure-game
```

## Instructions

Execute with @spec-task-executor agent the following task: "Create Choice model in models/choice.py"

```
Use the @spec-task-executor agent to implement task 5: "Create Choice model in models/choice.py" for the adventure-game specification and include all the below context.
...
## Task Details
- Task ID: 5
- Description: Create Choice model in models/choice.py
- Leverage: models/base.py, models/node.py
- Requirements: 2.1, 2.2

## Instructions
- Implement ONLY task 5: "Create Choice model in models/choice.py"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks adventure-game 5 --mode complete
...
```bash
claude-code-spec-workflow get-tasks adventure-game 5 --mode complete
```
