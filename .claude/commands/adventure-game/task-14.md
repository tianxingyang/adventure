# adventure-game - Task 14

Execute task 14 for the adventure-game specification.

## Task Description
Create project API routes in api/routes/projects.py
...
## Usage
```
/Task:14-adventure-game
```

## Instructions

Execute with @spec-task-executor agent the following task: "Create project API routes in api/routes/projects.py"

```
Use the @spec-task-executor agent to implement task 14: "Create project API routes in api/routes/projects.py" for the adventure-game specification and include all the below context.
...
## Task Details
- Task ID: 14
- Description: Create project API routes in api/routes/projects.py
- Leverage: services/project
- Requirements: 6.1, 6.2

## Instructions
- Implement ONLY task 14: "Create project API routes in api/routes/projects.py"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks adventure-game 14 --mode complete
...
```bash
claude-code-spec-workflow get-tasks adventure-game 14 --mode complete
```
