# adventure-game - Task 17

Execute task 17 for the adventure-game specification.

## Task Description
Create main FastAPI app in main.py

## Code Reuse
**Leverage existing code**: api/routes/projects.py, api/routes/nodes.py, api/routes/games.py
...
## Usage
```
/Task:17-adventure-game
```

## Instructions

Execute with @spec-task-executor agent the following task: "Create main FastAPI app in main.py"

```
Use the @spec-task-executor agent to implement task 17: "Create main FastAPI app in main.py" for the adventure-game specification and include all the below context.
...
## Task Details
- Task ID: 17
- Description: Create main FastAPI app in main.py
- Leverage: api/routes/projects.py, api/routes/nodes.py, api/routes/games.py
- Requirements: 1.1

## Instructions
- Implement ONLY task 17: "Create main FastAPI app in main.py"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks adventure-game 17 --mode complete
...
```bash
claude-code-spec-workflow get-tasks adventure-game 17 --mode complete
```
