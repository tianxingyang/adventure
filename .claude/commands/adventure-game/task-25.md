# adventure-game - Task 25

Execute task 25 for the adventure-game specification.

## Task Description
Create ProjectBrowser component in src/components/ProjectBrowser.js

## Code Reuse
**Leverage existing code**: src/stores/projectStore.js, src/components/common/
...
## Usage
```
/Task:25-adventure-game
```

## Instructions

Execute with @spec-task-executor agent the following task: "Create ProjectBrowser component in src/components/ProjectBrowser.js"

```
Use the @spec-task-executor agent to implement task 25: "Create ProjectBrowser component in src/components/ProjectBrowser.js" for the adventure-game specification and include all the below context.
...
## Task Details
- Task ID: 25
- Description: Create ProjectBrowser component in src/components/ProjectBrowser.js
- Leverage: src/stores/projectStore.js, src/components/common/
- Requirements: 6.1, 6.2

## Instructions
- Implement ONLY task 25: "Create ProjectBrowser component in src/components/ProjectBrowser.js"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks adventure-game 25 --mode complete
...
```bash
claude-code-spec-workflow get-tasks adventure-game 25 --mode complete
```
